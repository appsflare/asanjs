...
gulp.task('build-index', function () {
    var importsToAdd = [];
    var files = ['baseCustomElement.js', 'asan-element.js'].map(function (file) {
...
gulp.task('build', function (callback) {
    return runSequence(
        'clean',
        'build-index', ['build-es6', 'build-commonjs', 'build-amd', 'build-system' /*, 'bundle-jspm', 'copy-test-html'*/ ],
        'build-dts',
        callback
    );
});
